...
void MUIWidgetComponent::UpdateAnchoredLocation()
{
	...
	switch (m_anchor) {
	case EUIAnchor::TopLeft:      anchorOffset = { 0.0f, 0.0f }; break;
	case EUIAnchor::TopCenter:    anchorOffset = { parentSize.X * 0.5f, 0.0f }; break;
	case EUIAnchor::TopRight:     anchorOffset = { parentSize.X, 0.0f }; break;
	case EUIAnchor::MiddleLeft:   anchorOffset = { 0.0f, parentSize.Y * 0.5f }; break;
	case EUIAnchor::MiddleCenter: anchorOffset = { parentSize.X * 0.5f, parentSize.Y * 0.5f }; break;
	case EUIAnchor::MiddleRight:  anchorOffset = { parentSize.X, parentSize.Y * 0.5f }; break;
	case EUIAnchor::BottomLeft:   anchorOffset = { 0.0f, parentSize.Y }; break;
	case EUIAnchor::BottomCenter: anchorOffset = { parentSize.X * 0.5f, parentSize.Y }; break;
	case EUIAnchor::BottomRight:  anchorOffset = { parentSize.X, parentSize.Y }; break;
	}
