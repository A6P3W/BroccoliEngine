...
public:
	...
	{
		static_assert(std::is_trivially_copyable_v<T>, "FNetBuffer::Write requires trivially copyable types.");
	...
	{
		static_assert(std::is_trivially_copyable_v<T>, "FNetBuffer::Read requires trivially copyable types.");
