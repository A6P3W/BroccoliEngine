...
enum class ENetPacketReliability
{
	Reliable,
	Unreliable
};
...
public:
	...
	bool SendToServer(const FNetBuffer& Buffer, ENetPacketReliability Reliability = ENetPacketReliability::Reliable, uint8_t ChannelId = 0);
	bool SendToClient(FNetworkConnectionId ConnectionId, const FNetBuffer& Buffer, ENetPacketReliability Reliability = ENetPacketReliability::Reliable, uint8_t ChannelId = 0);
	bool Broadcast(const FNetBuffer& Buffer, ENetPacketReliability Reliability = ENetPacketReliability::Reliable, uint8_t ChannelId = 0);
...
private:
	...
	bool SendToPeer(ENetPeer* Peer, const FNetBuffer& Buffer, ENetPacketReliability Reliability, uint8_t ChannelId);
