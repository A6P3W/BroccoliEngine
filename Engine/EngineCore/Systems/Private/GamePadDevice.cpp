...
GamepadDevice::GamepadDevice(int padIndex) {
  switch (padIndex) {
    case 1:
      PadInputType = DX_INPUT_PAD1;
      break;
    case 2:
      PadInputType = DX_INPUT_PAD2;
      break;
    case 3:
      PadInputType = DX_INPUT_PAD3;
      break;
    case 4:
      PadInputType = DX_INPUT_PAD4;
      break;
    default:
      PadInputType = DX_INPUT_PAD1;
      break;
...
void GamepadDevice::Update() {
  ...
  if (GetJoypadXInputState(PadInputType, reinterpret_cast<DxLib::XINPUT_STATE*>(&xinputState)) ==
      0) {
...
bool GamepadDevice::GetPressing(int code) const { return (Buttons & code); }

bool GamepadDevice::GetRelease(int code) const { return (PrevButtons & code) && !(Buttons & code); }
