...
def EncryptLevels(
  Arguments: argparse.Namespace, InputDirectory: Path, OutputDirectory: Path
) -> int:
...
def ParseArguments() -> argparse.Namespace:
  ...
  Parser.add_argument(
    "--decrypt", action="store_true", help="Convert .BLevel files to formatted .BLevel.json files"
  )
